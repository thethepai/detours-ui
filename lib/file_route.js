            ...
            if (!is_hooking) {
                ...
                ws2.onmessage = function (e2) {
                    ...
                    if (info.eventID == "MessageBox") {
                        ...
                        } else if (info.event.Operation == "MessageBoxB") {
                    ...
                    if (info.eventID == "File") {
                        ...
                        } else if (info.event.Operation == "FileCopy") {
                    ...
                    if (info.eventID == "Socket") {
                        ...
                        if (info.event.Operation == "socket") {
                            ...
                            $('#c_buf').html('buf:' + convertToHex(info.event.buf));
                            ...
                            $('#d_buf').html('buf:' + convertToHex(info.event.buf));
                            ...
                            $('#f_buf').html('buf:' + convertToHex(info.event.buf));
