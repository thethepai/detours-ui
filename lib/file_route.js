layui.use(['layer', 'table', 'carousel', 'element', 'util', 'form', 'tree', 'jquery'], function () {
    ...
    var exeAndHook_default = {
        ...
        "hookPath": "D:\\programming_works\\vscodeworks\\softwareSec\\hust-detours\\dllmain\\x64\\Debug",
        "hookPath_dll": "D:\\programming_works\\vscodeworks\\softwareSec\\hust-detours\\dllmain\\x64\\Debug\\Dll1.0.dll"
    };
    var exeAndHook_info = {
        "exePath": [],
        "hookPath": [],
            ...
            if (!is_hooking) {
                ...
                ws.onmessage = function (e) {
                    ...
                    if ("EXE" in info) {
                        ...
                        localStorage.setItem("EXEinfo", JSON.stringify(dataToStore));
                    }
                    if ("OUTPUT" in info) {
                        // 给显示页面发送信息，通过localStorage
                        localStorage.setItem("OUTPUTinfo", JSON.stringify(info));
                    }
                };
